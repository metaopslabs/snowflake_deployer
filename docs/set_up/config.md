...
| `IMPORT_OBJECT_TYPES`                 | (List) List of object types to import for subcommand = IMPORT only.  If empty list of not included, all object types will be imported.  Valid object types:<ul><li>DATABASE</li><li>FUNCTION</li><li>MASKING POLICY</li><li>OBJECT</li><li>PROCEDURE</li><li>ROLE</li><li>ROW ACCESS POLICY</li><li>SCHEMA</li><li>TAG</li><li>TASK</li><li>WAREHOUSE</li></ul> |
